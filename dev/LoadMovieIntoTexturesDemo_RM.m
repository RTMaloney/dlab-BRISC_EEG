function LoadMovieIntoTexturesDemo_RM(moviename, fromTime, toTime, indexisFrames, benchmark, async, preloadSecs, specialflags, pixelFormat)
%
...
if isempty(moviename)
    ...
    moviename = ['C:\Users\BRISC\Videos\The Wiggles - Romp Bomp A Stomp.mp4'];
end;
...
try    
    ...
    while(count>0)
        ...
        Screen('DrawTexture', win, texids(currentindex), [], [0 0 320 160]);
