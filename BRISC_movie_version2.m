function BRISC_movie_version2
%
% This version is set to version 2: a simpler version with fewer conditions
% (6 instead of 10).
% Version 2 omits the double cue and no cue, no tone conditions.
%
% Inputs (requested):
...
Res.ExperimentName = 'BRISC_movie_version2';
